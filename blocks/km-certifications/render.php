<?php
/**
 * Block: KM Certifications
 * Renders the certifications and memberships section.
 */
$theme_uri = get_template_directory_uri();
?>
<section class="section-certification-membership" tabindex="0">
    <h2 class="section-title"><span>Certifications &amp; Memberships</span></h2>
    ...
    <div class="member-grid">
        ...
        <div class="skill">
            <a href="https://www.credly.com/badges/6d27f144-208c-49c4-ac35-897e71123812/public_url" target="_blank">
                <img src="<?php echo esc_url( $theme_uri . '/images/member/iaap-professional-member.png' ); ?>" width="200" height="200" alt="IAAP Professional Member">
            </a>
            <div class="skill-name">IAAP Professional Member</div>
        </div>

        <div class="skill">
            <a href="<?php echo esc_url( $theme_uri . '/images/member/accesstia-accessibility-fundamentials.pdf' ); ?>" target="_blank">
                <img src="<?php echo esc_url( $theme_uri . '/images/member/accesstia-accessibility.webp' ); ?>" width="200" height="200" alt="Accesstia Accessibility Fundamentals">
            </a>
        ...
        <div class="skill">
            <a href="">
                <div id="r">
                    <style>
                        ...
                        .h { display:inline-block; background:#25a9ef; padding:6px; clip-path:var(--h) }
                        .a { width:200px; padding:24px 0 40px; display:flex; flex-direction:column; align-items:center; gap:8px; color:#fff; text-align:center; background:linear-gradient(153deg,#0667ff 18%,#204ecf 40%,#0f256e 80%); clip-path:var(--h); box-shadow:0 28px 50px rgba(6,30,96,.35) }
                        #r { font-family:proxima-nova,Arial,sans-serif }
                        .b { margin:0; font-size:19px; font-weight:700; line-height:1 }
                        .c { width:120px; height:1px; background:#25a9ef }
                        .d { font-size:16px; opacity:.8; margin-bottom:-6px }
                        .f { display:inline-flex; align-items:center; justify-content:center; padding:4px 20px; border-radius:6px; background:#296bff; color:#fff; font-size:16px; font-weight:500; text-decoration-thickness:.5px; text-underline-offset:2px }
                    </style>
                    <div class="h">
                        <div class="a">
            ...
            <div class="skill-name">Toptal</div>
        </div>
